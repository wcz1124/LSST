...
from draw_loss import draw_features
...
class FocalRegionLoss(nn.Module):
    ...
    def loss_formulation(self, recon, real):
        ...
        weight_matrix = matrix_tmp.clone().detach()
        weight_matrix_draw = weight_matrix.view(10, 32, 32, 1, 1, -1)
        weight_matrix_draw = weight_matrix_draw.contiguous().view(10, 32, 32)
        weight_matrix_draw = weight_matrix_draw.cpu().numpy()
        draw_features(weight_matrix_draw,)
