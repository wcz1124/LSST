def set_template(args):
    ...
    if args.template.find('mst') >= 0:
        ...
        args.input_mask = 'Phi'
    if args.template.find('esst') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi'
    if args.template.find('lsst') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'mask'

    if args.template.find('lsstm') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'mask'
        
    if args.template.find('messt') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi'
    if args.template.find('bmst') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi'
        
    if args.template.find('gmst') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi' 
    
    if args.template.find('wmst') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi'
    if args.template.find('esst_nmm') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi'
    ...
    if args.template.find('mst_plus_plus') >= 0:
        ...
        args.input_mask = 'Mask'
        args.scheduler = 'CosineAnnealingLR'
    if args.template.find('esst_plus_plus') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Mask'
        args.scheduler = 'CosineAnnealingLR'

    if args.template.find('lsstm_plus_plus') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Mask'
        args.scheduler = 'CosineAnnealingLR'
    if args.template.find('esst_plus_plus') >= 0:
    ...
    if args.template.find('messt_plus_plus_hd') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Mask'
        args.scheduler = 'CosineAnnealingLR'

    if args.template.find('messtnm') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Mask'
        args.scheduler = 'CosineAnnealingLR'
